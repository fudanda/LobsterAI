...
const providerLinks: Partial<Record<ProviderType, { website: string; apiKey?: string }>> = {
  ...
  lzclaw: { website: 'https://lz.srmtj.com/', apiKey: 'https://lz.srmtj.com/console/token' },
  moonshot: {
  ...
  useEffect(() => {
    try {
      ...
      if (config.api) {
        ...
        } else if (normalizedApiBaseUrl.includes('lzclaw')) {
          setActiveProvider('lzclaw');
          setProviders(prev => ({
            ...prev,
            lzclaw: {
              ...prev.lzclaw,
        ...
        return (
          <div className="flex h-full">
            ...
            <div className="w-2/5 border-r border-border pr-3 space-y-1.5 overflow-y-auto">
              ...
              {ModelProvidersUi.ShowAddCustomProvider &&
                      ...
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {ProviderRegistry.get('qwen')?.apiKeyUrl && (
                          <button
                            type="button"
                            onClick={() =>
                              void window.electron.shell.openExternal(ProviderRegistry.get('qwen')!.apiKeyUrl!)
                            }
                            className="text-[11px] text-claude-accent hover:underline transition-colors"
                          >
                            {i18nService.t('getApiKey')} →
        ...
        return (
          <div className="flex min-h-full flex-col items-center pt-6 pb-3">
            ...
            <img
              src="logo.png"
              alt="LobsterAI"
              className="w-20 h-auto mb-3 cursor-pointer select-none"
              onClick={() => {
