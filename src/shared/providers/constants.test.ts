...
describe('ProviderRegistry', () => {
  ...
  test('lzclaw default base URL matches OpenAI compat path', () => {
    ...
    expect(def?.defaultApiFormat).toBe(ApiFormat.OpenAI);
    expect(def?.defaultBaseUrl).toBe('https://120.53.3.76:8088/v1');
  });
  ...
  describe('getSwitchableBaseUrl', () => {
    test('returns anthropic url for providers with switchableBaseUrls', () => {
      ...
      expect(ProviderRegistry.getSwitchableBaseUrl(ProviderName.Lzclaw, 'anthropic')).toBe('https://120.53.3.76:8088');
    ...
    test('returns openai url for providers with switchableBaseUrls', () => {
      ...
      expect(ProviderRegistry.getSwitchableBaseUrl(ProviderName.Lzclaw, 'openai')).toBe('https://120.53.3.76:8088/v1');
